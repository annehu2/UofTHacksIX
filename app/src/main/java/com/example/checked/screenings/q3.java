...
public class q3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_q3, container, false);
    ...
    protected void prev(View view) {
        Navigation.findNavController(view).navigate(R.id.action_q3_to_q2);
    }

    protected void next(View view) {
        Navigation.findNavController(view).navigate(R.id.action_q3_to_q4);
    }
}